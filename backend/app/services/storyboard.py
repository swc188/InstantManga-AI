...
要求：
1. 每个镜头包含：画面描述、景别（特写/近景/中景/远景/全景）、拍摄角度（平视/俯拍/仰拍/侧拍/主观）、台词（如有）、情绪标签
2. 每 3-5 个镜头切换一次景别或拍摄角度，避免单调
3. 动作场景拆分为多个连续镜头（如"摔杯子"拆为"抓起杯子→砸向地面→碎片飞溅"）
4. 相邻镜头画面要有连贯性，跳跃时添加过渡镜头
5. 总镜头数控制在 20-30 个，对应 1-2 分钟时长

输出 JSON 格式：
{"storyboards":[{"shot_no":1,"scene_desc":"","shot_type":"","camera_angle":"","dialogue":"","emotion":"","duration":1.8}]}"""
